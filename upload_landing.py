...
ZIP_FILE = r"c:\Users\PC\Documents\code\ladifinal\ladipagetest-vantai.zip"
SUBDOMAIN = "the-tap-huan-van-tai"

# User credentials (you'll need to be logged in or use API key)
# For now, we'll try to upload without authentication to test
